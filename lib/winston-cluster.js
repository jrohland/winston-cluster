...
//
var Cluster = exports.Cluster = function(options, loggerName) {
    options = options || {};
...
//
var bindListeners = exports.bindListeners = function(instance) {
...
var bindMultipleListeners = exports.bindMultipleListeners = function(instances) {
    function messageHandler(msg) {
        if (msg.cmd && msg.cmd === 'log' && msg.loggerName) {
            ...
            instances
              .filter(logger => {
                return logger.name === msg.loggerName;
              })
              .forEach(logger => {
...
Cluster.prototype.log = function(level, msg, meta, callback) {
    ...
    var message = {
        ...
        level: level,
        msg: msg,
        meta: (meta instanceof Error ? serializeError(meta) : meta)
    };
